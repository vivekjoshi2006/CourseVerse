          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch w-full">
            ...
            <div className="lg:col-span-8 xl:col-span-9 relative bg-white/95 backdrop-blur-2xl p-4 sm:p-5 rounded-3xl border border-indigo-100/80 shadow-[0_12px_40px_rgba(79,70,229,0.06)] flex flex-col justify-between gap-5 h-full transition-all">
              ...
              <div className="flex flex-col gap-3 flex-1 justify-center w-full">
                ...
                {/* Top Row Dropdowns (Platform, Level, Duration) */}
                  ...
                  <div className="relative w-full" data-dropdown>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        ...
                        <div className="text-left min-w-0 truncate">
                          <p className="text-[14px] font-bold uppercase text-sky-600">Platform</p>
                    ...
                    {openDropdown === 'platform' && (
                      <div className="absolute left-0 top-full mt-2 w-56 max-w-[85vw] bg-white backdrop-blur-2xl p-2 rounded-2xl border border-sky-100 shadow-2xl shadow-sky-500/20 z-50 animate-in fade-in zoom-in-95 duration-150">
                        <div className="px-2 py-1.5 text-[14px] font-bold text-sky-600 uppercase tracking-wider">Select Source</div>
                        <button
                          type="button"
                        ...
                        >
                          ...
                          <span className={`text-[14px] px-1.5 py-0.5 rounded-full ${platformFilter === 'all' ? 'bg-white/20 text-white' : 'bg-sky-100 text-sky-700'}`}>
                        ...
                        {availablePlatforms.filter(p => p !== 'all').map(prov => (
                          ...
                          >
                            ...
                            <span className={`text-[14px] px-1.5 py-0.5 rounded-full ${platformFilter === prov ? 'bg-white/20 text-white' : 'bg-sky-100 text-sky-700'}`}>
                  ...
                  <div className="relative w-full" data-dropdown>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        ...
                        <div className="text-left min-w-0 truncate">
                          <p className="text-[14px] font-bold uppercase tracking-wider text-purple-600">Level</p>
                    ...
                    {openDropdown === 'level' && (
                      <div className="absolute left-0 top-full mt-2 w-56 max-w-[85vw] bg-white backdrop-blur-2xl p-2 rounded-2xl border border-purple-100 shadow-2xl shadow-purple-500/20 z-50 animate-in fade-in zoom-in-95 duration-150">
                        <div className="px-2 py-1.5 text-[14px] font-bold text-purple-600 uppercase tracking-wider">Difficulty Level</div>
                        {[
                  ...
                  <div className="relative w-full" data-dropdown>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        ...
                        <div className="text-left min-w-0 truncate">
                          <p className="text-[14px] font-bold uppercase tracking-wider text-emerald-600">Duration</p>
                          <p className="text-[14px] font-extrabold truncate">
                    ...
                    {openDropdown === 'duration' && (
                      <div className="absolute left-0 top-full mt-2 w-64 max-w-[85vw] bg-white backdrop-blur-2xl p-2 rounded-2xl border border-emerald-100 shadow-2xl shadow-emerald-500/20 z-50 animate-in fade-in zoom-in-95 duration-150">
                        <div className="px-2 py-1.5 text-[14px] font-bold text-emerald-600 uppercase tracking-wider">Estimated Time</div>
                        {[
                ...
                {/* Bottom Row Dropdowns (Language, Sort By) */}
                  ...
                  <div className="relative w-full" data-dropdown>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        ...
                        <div className="text-left min-w-0 truncate">
                          <p className="text-[14px] font-bold uppercase tracking-wider text-rose-600">Language</p>
                          <p className="text-[14px] font-extrabold truncate">
                    ...
                    {openDropdown === 'language' && (
                      <div className="absolute left-0 top-full mt-2 w-52 max-w-[85vw] bg-white backdrop-blur-2xl p-2 rounded-2xl border border-rose-100 shadow-2xl shadow-rose-500/20 z-50 animate-in fade-in zoom-in-95 duration-150">
                        <div className="px-2 py-1.5 text-[14px] font-bold text-rose-600 uppercase tracking-wider">Select Language</div>
                        {[
                  ...
                  <div className="relative w-full" data-dropdown>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        ...
                        <div className="text-left min-w-0 truncate">
                          <p className="text-[14px] font-bold uppercase tracking-wider text-amber-600">Sort By</p>
                          <p className="text-[14px] font-extrabold truncate">
                    ...
                    {openDropdown === 'sort' && (
                      <div className="absolute right-0 sm:left-0 top-full mt-2 w-52 max-w-[85vw] bg-white backdrop-blur-2xl p-2 rounded-2xl border border-amber-100 shadow-2xl shadow-amber-500/20 z-50 animate-in fade-in zoom-in-95 duration-150">
                        <div className="px-2 py-1.5 text-[14px] font-bold text-amber-600 uppercase tracking-wider">Sort Order</div>
                        {[
